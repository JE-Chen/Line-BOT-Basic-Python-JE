...
from linebot.models import (
    ...
    LocationSendMessage, VideoSendMessage, BaseSize, Video, ExternalLink, MessageImagemapAction, ImagemapArea,
    FlexSendMessage,
...
Line_Main = Line_MessageMain(line_bot_api, MessageEvent, TextMessage, TextSendMessage, AudienceRecipient, Limit,
                             ...
                             LocationSendMessage,
                             VideoSendMessage, QuickReply, ImagemapSendMessage, BaseSize, Video, ExternalLink,
                             URIImagemapAction,
